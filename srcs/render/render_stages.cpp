	...
	// draw Registers sector ----------------------------------------------------------------------------------------
		...
		// draw mux sector --------------------------------------------------------------------------------------------
			...
			// draw lines -------------------------------------------------------------------------------------------------
				...
				DrawLineEx(Vector2{ 1420, 1820 }, Vector2{ 1420, 1883.3 }, 5.0f, BLACK);
				DrawLineEx(Vector2{ 1420, 1883.3 }, Vector2{ 65, 1883.3 }, 5.0f, BLACK);
				DrawLineEx(Vector2{ 65, 1883.3 }, Vector2{ 65, -230 }, 5.0f, BLACK);
				DrawLineEx(Vector2{ 65, -230 }, Vector2{ -75, -230 }, 5.0f, BLACK);
...
bool	render_memory_access(Info &info) {
	// draw Data memory sector --------------------------------------------------------------------------------------
		...
		// draw lines -------------------------------------------------------------------------------------------------
			...
			DrawCircle(3250, 465, 10, GOLD);
			DrawLineEx(Vector2{ 3250, 465 }, Vector2{ 3250, 1720 }, 5.0f, GOLD);
			DrawLineEx(Vector2{ 3250, 1720 }, Vector2{ 3050, 1720 }, 5.0f, GOLD);

			DrawCircle(3150, 965, 10, GOLD);
			DrawLineEx(Vector2{ 3150, 965 }, Vector2{ 3150, 1620 }, 5.0f, GOLD);
			DrawLineEx(Vector2{ 3150, 1620 }, Vector2{ 3050, 1620 }, 5.0f, GOLD);
		// draw lines -------------------------------------------------------------------------------------------------
		// draw mux sector -----------------------------------------------------------------------------------------------
			DrawRectangleRoundedLines(Rectangle{ 2950, 1550, 100, 240 }, 1.0f, 0, 5.0f, BLACK);
			// draw text ------------------------------------------------------------------------------------------------
				DrawTextEx(GetFontDefault(), "M", Vector2{ 2977, 1575 }, 60.0f, 3.0f, BLACK);
				DrawTextEx(GetFontDefault(), "U", Vector2{ 2980, 1645 }, 60.0f, 3.0f, BLACK);
				DrawTextEx(GetFontDefault(), "X", Vector2{ 2980, 1715 }, 60.0f, 3.0f, BLACK);
			// draw text ------------------------------------------------------------------------------------------------
			// draw line ------------------------------------------------------------------------------------------------
				draw_down_arrow(3000, 1450, 3000, 1550, BLACK);
			// draw line ------------------------------------------------------------------------------------------------
			// draw MEM/WB Mem Read signal --------------------------------------------------------------------------------
				DrawRectangleLinesEx(Rectangle{ 2880, 1310, 240, 140 }, 5.0f, BLUE);
				DrawRectangle(2880, 1310, 240, 140, Fade(BLUE, 0.2f));
				// draw text --------------------------------------------------------------------------------------------
					DrawTextEx(GetFontDefault(), "MEM/WB", Vector2{ 2910, 1335 }, 40.0f, 3.0f, BLUE);
					DrawTextEx(GetFontDefault(), "MemRead", Vector2{ 2910, 1385 }, 40.0f, 3.0f, BLUE);
				// draw text --------------------------------------------------------------------------------------------
			// draw MEM/WB Mem Read signal --------------------------------------------------------------------------------
		// draw mux sector -----------------------------------------------------------------------------------------------
	// draw Data memory sector --------------------------------------------------------------------------------------

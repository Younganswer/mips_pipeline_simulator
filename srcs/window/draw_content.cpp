...
bool	draw_content(void) {
	...
	draw_down_arrow(290, -1500, 290, 120, GOLD);
	DrawRectangle(-3000+200, 120, 180, 140, YELLOW);
	DrawRectangleLinesEx((Rectangle){ -3000+200, 120, 180, 140 }, 3.0f, GOLD);
	DrawText("PC", -3000+265, 160, 40, GOLD);
	DrawText("Write", -3000+240, 190, 40, GOLD);
	draw_down_arrow(290, 260, 290, 340, GOLD);
